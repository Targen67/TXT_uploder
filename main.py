...
photologo = 'https://i.ibb.co/qLdbQZg1/x.jpg' #https://envs.sh/GV0.jpg
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/Casauravs"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+hR3abi3piUUxYzY1"),
        ],
    ]
)
...
image_urls = [
    "https://i.ibb.co/XZKGjP03/x.jpg",
    "https://i.ibb.co/qLdbQZg1/x.jpg",
...
async def start_command(bot: Client, message: Message):
    ...
    caption = (
        "𝐇𝐞𝐥𝐥𝐨 𝐃𝐞𝐚𝐫 👋!\n\n➠ 𝐈 𝐚𝐦 𝐚 𝐓𝐗𝐓 𝐔𝐩𝐥𝐨𝐚𝐝𝐞𝐫 𝐁𝐨𝐭\n\n➠ I Can Extract Videos & PDFs From Your Txt File and Upload to Telegram!\n\n➠ For Guide Use Command /help 📖\n\n➠ 𝐌𝐚𝐝𝐞 𝐁𝐲 :  SAURAV BOTS 💪 "
    )
